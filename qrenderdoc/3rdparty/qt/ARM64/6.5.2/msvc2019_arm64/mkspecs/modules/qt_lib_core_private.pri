...
QT.core_private.enabled_features = doubleconversion mimetype-database cpp-winrt sha3-fast hijricalendar datetimeparser pcre2 debug alloca_malloc_h alloca dbus gui network printsupport sql testlib widgets xml openssl relocatable cross_compile msvc_obj_debug_info force_debug_info largefile precompile_header
...
QMAKE_LIBS_OPENSSL_RELEASE = -L"C:/openssl_arm64/lib" -llibssl
QMAKE_INCDIR_OPENSSL = C:/openssl_arm64/include
